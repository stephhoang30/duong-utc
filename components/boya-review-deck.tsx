...
export function BoyaReviewDeck({ initialLesson = 1 }: { initialLesson?: number }) {
  ...
  return <section className={`panel boya-quizlet-panel ${reviewActive ? "is-review-active" : ""}`} aria-label="Ôn tập BOYA 1">
    {!reviewActive && <><header className="boya-quizlet-head">
    ...
    {mode === "vocabulary" && <VocabularyDeck lesson={lesson} totalTerms={data.totalTerms} onSessionChange={setReviewActive} />}
